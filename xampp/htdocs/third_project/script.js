...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var form = new _modules_form__WEBPACK_IMPORTED_MODULE_4__["default"]('.form', 'assets/question.php');
  form.init();
});
...
function () {
  ...
  _createClass(Difference, [{
    key: "bindTriggers",
    value: function bindTriggers(container, arr, i) {
      ...
      mailInputs.forEach(function (input) {
        input.addEventListener('keypress', function (e) {
          if (e.key.match(/[^a-z 0-9 @ \.]/ig)) {
            // проверка регулярным выражением, чтобы вводились только символы a-z, 0-9, @, .;
            e.preventDefault();
          }
        });
      });
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          if (document.querySelector('iframe#frame')) {
            ...
            _this.overlay.classList.add('fadeIn');
          } else {
    ...
    value: function render() {
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          ...
          _this2.slides.forEach(function (slide) {// slide.classList.add('animated', 'fadeInDown');
          });
        });
...
function (_Slider) {
  ...
  function MiniSlider(container, prev, next, activeClass, animated, autoplay, buttonsInArray) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, prev, next, activeClass, animated, autoplay, buttonsInArray));
  }
  ...
  _createClass(MiniSlider, [{
    ...
    value: function nextSlide() {
      ...
      if (this.buttonsInArray) {
        var newSlides = this.container.querySelectorAll('.feed__item');
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        if (_this3.buttonsInArray) {
          var newSlides = _this3.container.querySelectorAll('.feed__item');

          var active = newSlides[newSlides.length - 1];

          _this3.container.insertBefore(active, newSlides[0]);

          newSlides.forEach(function (slide) {
            slide.classList.remove(_this3.activeClass);
          });
          active.classList.add(_this3.activeClass);
        } else {
          var _active = _this3.slides[_this3.slides.length - 1];
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      buttonsInArray = _ref.buttonsInArray;
  ...
  this.btns = document.querySelectorAll(btns), this.prev = document.querySelector(prev), this.next = document.querySelector(next), this.activeClass = activeClass, this.animated = animated, this.autoplay = autoplay, this.buttonsInArray = buttonsInArray, this.slideIndex = 1;
};
